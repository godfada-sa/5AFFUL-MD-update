...
function buildFreshLoginOptions(options = {}, browser, version, isPairingCode = false) {
  return {
    ...options,
    ...
    // A fresh QR session does not need to announce availability before it has
    // completed registration. Phone-number pairing matches MEGA-MD instead.
    markOnlineOnConnect: Boolean(isPairingCode),
  };
}
